...
Moriken001AI::Moriken001AI()
{
	srand((unsigned) time(NULL));
}

TimeLength Moriken001AI::GetTimeLength(float startX, float startY, int startAngle, float targetX, float targetY)
{
...
Command Moriken001AI::Update(TurnData turnData) {
